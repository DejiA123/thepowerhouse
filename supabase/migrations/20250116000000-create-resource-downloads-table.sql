...
CREATE INDEX idx_resource_downloads_resource_name ON public.resource_downloads(resource_name);
CREATE INDEX idx_resource_downloads_category ON public.resource_downloads(resource_category);
