...
BEGIN
    FOREACH loc IN ARRAY loc_list LOOP
        -- 1. Cleanup existing modules for this location to prevent duplicates
        DELETE FROM public.choir_academy_modules 
        WHERE location = loc AND title IN ('Biblical Foundations of Choir', 'The Power of Prayer in Choir');
