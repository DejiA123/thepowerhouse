...
export const BibleChapterContent = ({
  ...
  return (
    <div className="bible-page-full">
      {/* Header Bar */}
      <div className="flex items-center justify-between px-4 pb-3 pt-[calc(0.75rem+max(env(safe-area-inset-top),var(--sat-fallback,0px)))] bg-white/95 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-100/50">
