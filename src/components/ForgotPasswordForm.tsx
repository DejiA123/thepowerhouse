...
const ForgotPasswordForm = ({ onBackToLogin }: ForgotPasswordFormProps) => {
      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 dark:border-slate-700/30 transform hover:scale-[1.02] transition-all duration-500 hover:shadow-3xl dark:hover:shadow-2xl">
          <CardHeader className="text-center pb-8">
            <div className="mx-auto w-16 h-16 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-500/20 dark:to-green-600/20 rounded-full flex items-center justify-center mb-4 shadow-lg">
  ...
  return (
    <div className="w-full max-w-md relative z-10">
      <Card className="bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-3xl shadow-2xl border border-white/30 dark:border-slate-700/30 transform hover:scale-[1.02] transition-all duration-500 hover:shadow-3xl dark:hover:shadow-2xl">
        <CardHeader className="text-center pb-8">
          <div className="mx-auto w-16 h-16 bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-500/20 dark:to-red-600/20 rounded-full flex items-center justify-center mb-4 shadow-lg">
