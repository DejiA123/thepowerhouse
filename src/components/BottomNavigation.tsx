...
const BottomNavigation = () => {
  ...
  return (
    <nav
      ...
      data-version="v15-safari-align-refined"
      ...
      style={{
        ...
        // 34px is the refined height after user feedback (down from 44px)
        paddingBottom: isIPhone ? '34px' : '10px'
      }}
    ...
    >
      ...
      {/* Tiny v15 tag to confirm update */}
