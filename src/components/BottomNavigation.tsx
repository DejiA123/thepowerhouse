...
const BottomNavigation = () => {
  ...
  return (
    <nav
      className="w-full fixed bottom-[-165px] left-0 right-0 z-[100] border-t border-gray-200/60 dark:border-white/10 bg-white dark:bg-black backdrop-blur-lg h-[200px]"
      style={{
    ...
    >
      <div
        className="w-full h-[35px] flex justify-around touch-none select-none items-center"
      >
        {navigationItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-[28px] h-[28px] transition-colors duration-200 mb-0.5 ${isActive
