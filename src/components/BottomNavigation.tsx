...
const BottomNavigation = () => {
  ...
  return (
    <nav
      className="glass border-t-0 w-full shrink-0 pt-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] fixed bottom-0 left-0 right-0 z-50 rounded-none border-t border-white/10"
      onTouchStart={(e) => e.stopPropagation()}
      onTouchMove={(e) => e.preventDefault()}
      draggable="false"
    >
      <div className="flex justify-around py-0 touch-none select-none">
