...
const Header = () => {
  ...
  return (
    <header className={`glass fixed top-0 w-full z-40 transition-all duration-300 ease-in-out ${isBiblePage && isScrolled ? 'transform -translate-y-full opacity-0' : 'transform translate-y-0 opacity-100'
      }`}>
