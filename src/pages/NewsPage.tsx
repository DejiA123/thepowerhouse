  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950/50 space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      {isAdmin && (
        ...
        >
          <DialogContent className="w-full h-[100dvh] max-w-none m-0 p-0 rounded-none border-none shadow-none bg-white dark:bg-slate-950 flex flex-col overflow-hidden fixed inset-0 top-0 left-0 translate-x-0 translate-y-0 z-[200] [&>button]:z-[310] [&>button]:right-6 [&>button]:top-[calc(env(safe-area-inset-top)+1.5rem)] sm:[&>button]:top-8 [&>button]:h-12 [&>button]:w-12 [&>button]:bg-white/90 [&>button]:dark:bg-slate-900/90 [&>button]:backdrop-blur-2xl [&>button]:rounded-2xl [&>button]:shadow-2xl [&>button]:border-2 [&>button]:border-slate-200/50 [&>button]:dark:border-slate-800/50 [&>button]:opacity-100 [&>button]:transition-all [&>button]:duration-300 [&>button]:hover:scale-110 [&>button]:hover:rotate-90 [&>button]:active:scale-90 [&>button]:hover:bg-white [&>button]:dark:hover:bg-slate-800 [&>button]:hover:border-indigo-500 [&>button]:flex [&>button]:items-center [&>button]:justify-center [&>button_svg]:h-6 [&>button_svg]:w-6 [&>button_svg]:text-slate-950 [&>button_svg]:dark:text-white [&>button_svg]:transition-colors">
            <div
