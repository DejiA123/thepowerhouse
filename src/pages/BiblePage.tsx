    ...
    return (
      <div className="min-h-screen bg-background pb-[72px] pt-0">
        ...
        <Dialog open={showHighlightsList} onOpenChange={setShowHighlightsList}>
          <DialogContent className="fixed w-screen h-[100dvh] max-w-none m-0 p-0 overflow-hidden bg-white dark:bg-gray-950 border-none rounded-none flex flex-col pt-[calc(3rem + env(safe-area-inset-top, 0px))] [&>button]:top-[calc(1.5rem + env(safe-area-inset-top, 0px))]">
