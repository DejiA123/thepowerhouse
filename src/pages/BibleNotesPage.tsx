                    ...
                    >
                        {selectedNote && (
                            <div className="flex flex-col h-full bg-white dark:bg-gray-950">
                                ...
                                <div className="relative flex items-center justify-between px-4 h-auto min-h-[4.5rem] border-b border-gray-100 dark:border-gray-800 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md z-50 pt-[calc(3rem + env(safe-area-inset-top, 0px))] pb-4">
            ...
            {showNewNoteDialog && (
                <div className="fixed top-0 inset-x-0 bottom-0 bg-white dark:bg-black z-[9999] overflow-hidden flex flex-col sm:rounded-t-[2.5rem] shadow-[0_-8px_30px_rgb(0,0,0,0.12)] border-t border-gray-100 dark:border-gray-800">
                    ...
                    <div className="flex-1 flex flex-col w-full relative bg-gray-50 dark:bg-black overflow-hidden">
                        {/* Premium Navbar */}
                        <div className="flex items-center justify-between w-full px-6 h-auto min-h-[4.5rem] border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm pt-[calc(3rem + env(safe-area-inset-top, 0px))] pb-4">
