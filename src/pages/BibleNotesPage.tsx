...
const BibleNotesPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-gray-950">
            ...
            <Dialog open={showNoteDialog} onOpenChange={(open) => {
                ...
                <DialogPrimitive.Portal>
                    ...
                    <DialogPrimitive.Content
                        ...
                        className="fixed top-[max(env(safe-area-inset-top),60px)] inset-x-0 bottom-0 w-screen h-[calc(100dvh - max(env(safe-area-inset-top),60px))] max-w-none p-0 overflow-hidden bg-white dark:bg-gray-950 z-50 outline-none transform-none sm:rounded-t-[2.5rem] shadow-[0_-8px_30px_rgb(0,0,0,0.12)] border-t border-gray-100 dark:border-gray-800"
                    >
                        {selectedNote && (
            ...
            {showNewNoteDialog && (
                <div className="fixed top-[max(env(safe-area-inset-top),60px)] inset-x-0 bottom-0 w-screen h-[calc(100dvh - max(env(safe-area-inset-top),60px))] bg-white dark:bg-black z-[9999] overflow-hidden flex flex-col sm:rounded-t-[2.5rem] shadow-[0_-8px_30px_rgb(0,0,0,0.12)] border-t border-gray-100 dark:border-gray-800">
