  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-transparent">
      ...
      <video
        ...
        playsInline
        preload="auto"
        className="fixed inset-0 w-full h-full object-cover z-[9999] bg-black pointer-events-none"
        onError={(e) => {
      ...
      <div className="relative z-0 opacity-0 pointer-events-none bg-transparent flex flex-col items-center justify-between min-h-screen px-6 py-12">
