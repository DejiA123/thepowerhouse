...
ADD COLUMN IF NOT EXISTS brief_title TEXT DEFAULT 'Bishopric Consecration & Outpouring Convention',
...
ADD COLUMN IF NOT EXISTS brief_overview TEXT DEFAULT 'This brief contains a high-level summary of the project management of the forthcoming Bishopric Consecration & Outpouring Convention.',
...
SET 
  brief_title = COALESCE(brief_title, 'Bishopric Consecration & Outpouring Convention'),
  ...
  brief_overview = COALESCE(brief_overview, 'This brief contains a high-level summary of the project management of the forthcoming Bishopric Consecration & Outpouring Convention.'),
